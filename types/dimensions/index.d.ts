...
export type Dimension = BrickDimension | CubeDimension | LineXDimension | LineYDimension | LineZDimension | PyramidDimension | SideXDimension | SideYDimension | SlopeDimension;
export { AbstractDimension, BrickDimension, CubeDimension, LineXDimension, LineYDimension, LineZDimension, PyramidDimension, SideXDimension, SideYDimension, SlopeDimension, };
